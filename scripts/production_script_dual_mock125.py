...
from samana.Data.Mocks.mock_125_data import mock125
from samana.Model.Mocks.mock_125_model import Mock125ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock125()
model = Mock125ModelEPLM3M4Shear
