...
from samana.Data.Mocks_dual.mock_14_data_dual import Mock14Data_dual
from samana.Model.Mocks_dual.mock_14_model_dual import Mock14Model_dual
import os
import numpy as np
import sys
...
data_class = Mock14Data_dual()
model = Mock14Model_dual
