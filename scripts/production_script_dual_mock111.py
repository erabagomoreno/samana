...
from samana.Data.Mocks.mock_111_data import mock111
from samana.Model.Mocks.mock_111_model import Mock111ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock111()
model = Mock111ModelEPLM3M4Shear
