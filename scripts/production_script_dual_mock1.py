...
from samana.Data.Mocks_dual.mock_1_data_dual import Mock1Data_dual
from samana.Model.Mocks_dual.mock_1_model_dual import Mock1Model_dual
import os
import numpy as np
import sys


job_index = 1#int(sys.argv[1])
data_class = Mock1Data_dual
