...
from samana.Data.Mocks.mock_132_data import mock132
from samana.Model.Mocks.mock_132_model import Mock132ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock132()
model = Mock132ModelEPLM3M4Shear
