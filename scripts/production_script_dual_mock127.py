...
from samana.Data.Mocks.mock_127_data import mock127
from samana.Model.Mocks.mock_127_model import Mock127ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock127()
model = Mock127ModelEPLM3M4Shear
