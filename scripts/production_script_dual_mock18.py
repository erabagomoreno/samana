...
from samana.Data.Mocks_dual.mock_18_data_dual import Mock18Data_dual
from samana.Model.Mocks_dual.mock_18_model_dual import Mock18Model_dual
import os
import numpy as np
import sys
...
data_class = Mock18Data_dual()
model = Mock18Model_dual
