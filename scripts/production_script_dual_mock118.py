...
from samana.Data.Mocks.mock_118_data import mock118
from samana.Model.Mocks.mock_118_model import Mock118ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock118()
model = Mock118ModelEPLM3M4Shear
