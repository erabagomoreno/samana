...
from samana.Data.Mocks_dual_wdm.mock_3_data_dual_wdm import Mock3Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_3_model_dual_wdm import Mock3Model_dual
import os
import numpy as np
import sys
...
data_class = Mock3Data_dual_wdm()
model = Mock3Model_dual
