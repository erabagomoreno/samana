...
from samana.Data.Mocks.mock_128_data import mock128
from samana.Model.Mocks.mock_128_model import Mock128ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock128()
model = Mock128ModelEPLM3M4Shear
