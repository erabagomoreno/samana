...
from samana.Data.Mocks_dual_wdm.mock_6_data_dual_wdm import Mock6Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_6_model_dual_wdm import Mock6Model_dual
import os
import numpy as np
import sys
...
data_class = Mock6Data_dual_wdm()
model = Mock6Model_dual
