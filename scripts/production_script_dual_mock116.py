...
from samana.Data.Mocks.mock_116_data import mock116
from samana.Model.Mocks.mock_116_model import Mock116ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock116()
model = Mock116ModelEPLM3M4Shear
