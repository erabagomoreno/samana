...
from samana.Data.Mocks_dual_wdm.mock_9_data_dual_wdm import Mock9Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_9_model_dual_wdm import Mock9Model_dual
import os
import numpy as np
import sys
...
data_class = Mock9Data_dual_wdm()
model = Mock9Model_dual
