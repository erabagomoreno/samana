...
from samana.Data.Mocks.mock_131_data import mock131
from samana.Model.Mocks.mock_131_model import Mock131ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock131()
model = Mock131ModelEPLM3M4Shear
