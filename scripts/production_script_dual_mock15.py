...
from samana.Data.Mocks_dual.mock_15_data_dual import Mock15Data_dual
from samana.Model.Mocks_dual.mock_15_model_dual import Mock15Model_dual
import os
import numpy as np
import sys
...
data_class = Mock15Data_dual()
model = Mock15Model_dual
