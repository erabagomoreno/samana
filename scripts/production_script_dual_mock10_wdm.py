...
from samana.Data.Mocks_dual_wdm.mock_10_data_dual_wdm import Mock10Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_10_model_dual_wdm import Mock10Model_dual
import os
import numpy as np
import sys
...
data_class = Mock10Data_dual_wdm()
model = Mock10Model_dual
