...
from samana.Data.Mocks.mock_117_data import mock117
from samana.Model.Mocks.mock_117_model import Mock117ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock117()
model = Mock117ModelEPLM3M4Shear
