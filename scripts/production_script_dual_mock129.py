...
from samana.Data.Mocks.mock_129_data import mock129
from samana.Model.Mocks.mock_129_model import Mock129ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock129()
model = Mock129ModelEPLM3M4Shear
