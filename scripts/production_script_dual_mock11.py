...
from samana.Data.Mocks_dual.mock_11_data_dual import Mock11Data_dual
from samana.Model.Mocks_dual.mock_11_model_dual import Mock11Model_dual
import os
import numpy as np
import sys
...
data_class = Mock11Data_dual()
model = Mock11Model_dual
