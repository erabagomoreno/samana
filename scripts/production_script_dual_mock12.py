...
from samana.Data.Mocks_dual.mock_12_data_dual import Mock12Data_dual
from samana.Model.Mocks_dual.mock_12_model_dual import Mock12Model_dual
import os
import numpy as np
import sys
...
data_class = Mock12Data_dual()
model = Mock12Model_dual
