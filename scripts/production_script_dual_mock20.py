...
from samana.Data.Mocks_dual.mock_20_data_dual import Mock20Data_dual
from samana.Model.Mocks_dual.mock_20_model_dual import Mock20Model_dual
import os
import numpy as np
import sys
...
data_class = Mock20Data_dual()
model = Mock20Model_dual
