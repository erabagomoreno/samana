...
from samana.Data.Mocks_dual_wdm.mock_2_data_dual_wdm import Mock2Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_2_model_dual_wdm import Mock2Model_dual
import os
import numpy as np
import sys
...
data_class = Mock2Data_dual_wdm()
model = Mock2Model_dual
