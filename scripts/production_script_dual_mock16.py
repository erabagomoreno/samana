...
from samana.Data.Mocks_dual.mock_16_data_dual import Mock16Data_dual
from samana.Model.Mocks_dual.mock_16_model_dual import Mock16Model_dual
import os
import numpy as np
import sys
...
data_class = Mock16Data_dual()
model = Mock16Model_dual
