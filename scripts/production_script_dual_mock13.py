...
from samana.Data.Mocks_dual.mock_13_data_dual import Mock13Data_dual
from samana.Model.Mocks_dual.mock_13_model_dual import Mock13Model_dual
import os
import numpy as np
import sys
...
data_class = Mock13Data_dual()
model = Mock13Model_dual
