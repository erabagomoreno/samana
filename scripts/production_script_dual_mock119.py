...
from samana.Data.Mocks.mock_119_data import mock119
from samana.Model.Mocks.mock_119_model import Mock119ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock119()
model = Mock119ModelEPLM3M4Shear
