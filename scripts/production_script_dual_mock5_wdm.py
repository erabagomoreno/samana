...
from samana.Data.Mocks_dual_wdm.mock_5_data_dual_wdm import Mock5Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_5_model_dual_wdm import Mock5Model_dual
import os
import numpy as np
import sys
...
data_class = Mock5Data_dual_wdm()
model = Mock5Model_dual
