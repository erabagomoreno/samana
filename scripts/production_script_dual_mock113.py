...
from samana.Data.Mocks.mock_113_data import mock113
from samana.Model.Mocks.mock_113_model import Mock113ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock113()
model = Mock113ModelEPLM3M4Shear
