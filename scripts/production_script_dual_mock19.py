...
from samana.Data.Mocks_dual.mock_19_data_dual import Mock19Data_dual
from samana.Model.Mocks_dual.mock_19_model_dual import Mock19Model_dual
import os
import numpy as np
import sys
...
data_class = Mock19Data_dual()
model = Mock19Model_dual
