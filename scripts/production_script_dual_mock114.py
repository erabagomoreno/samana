...
from samana.Data.Mocks.mock_114_data import mock114
from samana.Model.Mocks.mock_114_model import Mock114ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock114()
model = Mock114ModelEPLM3M4Shear
