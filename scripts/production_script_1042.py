...
from samana.Data.j1042 import J1042JWST
from samana.Model.j1042_model import J1042ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = J1042JWST()
model = J1042ModelEPLM3M4Shear
...
kwargs_sample_macro_fixed = {
    'satellite_1_theta_E': ['UNIFORM', 0.01, 0.15],
    'satellite_1_x': ['GAUSSIAN', 1.6553, 0.03],
    'satellite_1_y': ['GAUSSIAN', -0.2967, 0.03],
