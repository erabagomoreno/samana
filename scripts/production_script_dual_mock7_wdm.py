...
from samana.Data.Mocks_dual_wdm.mock_7_data_dual_wdm import Mock7Data_dual_wdm
from samana.Model.Mocks_dual_wdm.mock_7_model_dual_wdm import Mock7Model_dual
import os
import numpy as np
import sys
...
data_class = Mock7Data_dual_wdm()
model = Mock7Model_dual
