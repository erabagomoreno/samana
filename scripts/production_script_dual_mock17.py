...
from samana.Data.Mocks_dual.mock_17_data_dual import Mock17Data_dual
from samana.Model.Mocks_dual.mock_17_model_dual import Mock17Model_dual
import os
import numpy as np
import sys
...
data_class = Mock17Data_dual()
model = Mock17Model_dual
