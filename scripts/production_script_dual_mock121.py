...
from samana.Data.Mocks.mock_121_data import mock121
from samana.Model.Mocks.mock_121_model import Mock121ModelEPLM3M4Shear
import os
import numpy as np
import sys
...
data_class = mock121()
model = Mock121ModelEPLM3M4Shear
