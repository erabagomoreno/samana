...
class Mock15Model(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': ra_source, 'center_y': dec_source, 'e1': 0.2,
                  'e2': -0.2, 'R_sersic': 0.06, 'n_sersic': 5.5}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.19107250691324595,
                              'e2': 0.029535171861108933, 'gamma': 1.9331820500036354, 'a4_a': -0.008391361373742528,
                              'a3_a': -0.006805831362659183, 'delta_phi_m3': 0.36528103839369175,
                              'delta_phi_m4': 0.0}, {'gamma1': -0.01, 'gamma2': 0.07}]
