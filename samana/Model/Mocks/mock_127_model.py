...
class _Mock127ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock127ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock127ModelEPLM3M4Shear(_Mock127ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock127ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.0011935575440062789,
                              'e2': -0.056625829125346874, 'gamma': 1.9164802046350595, 'a3_a': 0.0016783340632907616,
                              'a4_a': 0.0003272813973420546,
                              'delta_phi_m3': -0.3634249274105767, 'delta_phi_m4': 0.0},
                             {'gamma1': -0.03, 'gamma2': 0.06}]
