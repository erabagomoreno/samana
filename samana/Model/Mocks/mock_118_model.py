...
class _Mock118ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock118ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock118ModelEPLM3M4Shear(_Mock118ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock118ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': -0.29452708091309837,
                              'e2': 0.03548187352118753, 'gamma': 2.0780466323978937, 'a3_a': -0.005847882808135716, 'a4_a': 0.003105258718250674,
                              'delta_phi_m3': 0.15520890958679923, 'delta_phi_m4': 0.0},
                             {'gamma1': -0.01, 'gamma2': 0.07}]
