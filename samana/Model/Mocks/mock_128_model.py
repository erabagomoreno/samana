...
class _Mock128ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock128ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock128ModelEPLM3M4Shear(_Mock128ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock128ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro =  [{'theta_E': 1.0, 'center_x': 0.0,
                               'center_y': 0.0, 'e1': 0.2344619902477684,
                               'e2': 0.16168052190299997, 'gamma': 1.8889142355492081,  'a3_a': 0.00934898000822758,
                               'a4_a': 0.012824832688183102,
                               'delta_phi_m3': -0.25340360102884685, 'delta_phi_m4': 0.0},
                              {'gamma1': -0.05, 'gamma2': -0.07}]
