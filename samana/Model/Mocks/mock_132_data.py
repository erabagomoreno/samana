...
class _Mock132ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock132ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock132ModelEPLM3M4Shear(_Mock132ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock132ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.26915710656743247,
                              'e2': 0.07843170309424773, 'gamma': 1.8670792202072168, 'a3_a': 0.00463268938671128,
                              'a4_a': -9.934618583092539e-05,
                              'delta_phi_m3': -0.2489988286949824, 'delta_phi_m4': 0.0},
                             {'gamma1': -0.06, 'gamma2': 0.03}]
        kwargs_lens_macro =  [{'theta_E': 1.0, 'center_x': 0.0,
                               'center_y': 0.0, 'e1': -0.17357011560361282,
                               'e2': 0.09847126081869678, 'gamma': 1.8270963295983582,  'a3_a': 0.015690416622262948,
                               'a4_a': 0.0013455829981936314,
                               'delta_phi_m3': 0.3279832726102607, 'delta_phi_m4': 0.0},
