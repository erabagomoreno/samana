...
class _Mock111ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock111ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock111ModelEPLM3M4Shear(_Mock111ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock111ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.18766421195242483,
                              'e2': 0.009961108690422845, 'gamma': 2.097116695683875, 'a3_a': -0.002733171674031033, 'a4_a': 0.009429492602938088,
                              'delta_phi_m3': 0.308885261072478376, 'delta_phi_m4': 0.0},
