...
class Mock11Model(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.1,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.05750376366439197,
                              'e2': 0.16209438330567794, 'gamma': 1.9681100995264538,
                              'a4_a': -0.0038259098896556345, 'a3_a': -0.00014642596529442495,
                              'delta_phi_m3': -0.33482079885157356, 'delta_phi_m4': 0.0},
...
class Mock11ModelTrueSource(Mock11Model):
