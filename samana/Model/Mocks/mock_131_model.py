...
class _Mock131ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock131ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock131ModelEPLM3M4Shear(_Mock131ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock131ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
