...
class _Mock116ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock116ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock116ModelEPLM3M4Shear(_Mock116ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock116ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.22561630075413547,
                              'e2': 0.009722441151216538, 'gamma': 2.026441749621089, 'a3_a': 0.009309300718773329, 'a4_a': 0.00031743541903811695,
                              'delta_phi_m3': -0.034820952561295415, 'delta_phi_m4': 0.0},
