...
class Mock4Model(MockModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        self._shapelets_order = shapelets_order
        super(Mock4Model, self).__init__(data_class, kde_sampler)

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 10.0, 'center_x': -0.0, 'center_y': -0.0, 'e1': 0.0,
                  'e2': -0.1, 'R_sersic': 0.07, 'n_sersic': 4.8}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.14902045524131477,
                              'e2': 0.16189838398964046, 'gamma': 2.145162560647839,
                              'a4_a': 0.0004500167278941548, 'a3_a': 0.002251807533098353,
                              'delta_phi_m3': 0.48907250375086353, 'delta_phi_m4': 0.0},
