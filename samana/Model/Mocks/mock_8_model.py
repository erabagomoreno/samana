...
class Mock8Model(MockModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        self._shapelets_order = shapelets_order
        super(Mock8Model, self).__init__(data_class, kde_sampler)

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 20.0, 'center_x': -0.0, 'center_y': -0.0, 'e1': 0.05,
                  'e2': -0.2, 'R_sersic': 0.034, 'n_sersic': 4.0}]
