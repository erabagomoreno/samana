...
class Mock2Model(MockModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        self._shapelets_order = shapelets_order
        super(Mock2Model, self).__init__(data_class, kde_sampler)

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 30.0, 'center_x': -0.06, 'center_y': -0.04, 'e1': 0.2,
                  'e2': 0.0, 'R_sersic': 0.095, 'n_sersic': 3.0}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.19537964099282026,
                              'e2': -0.158688169380922, 'gamma': 1.892554448155309, 'a4_a': -0.004348301531541436,
                              'a3_a': 0.00022775720058585444, 'delta_phi_m3': -0.06702598174099228,
                              'delta_phi_m4': 0.0}, {'gamma1': -0.06, 'gamma2': 0.03}]
