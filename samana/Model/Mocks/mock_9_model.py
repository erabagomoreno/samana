...
class Mock9Model(MockModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        self._shapelets_order = shapelets_order
        super(Mock9Model, self).__init__(data_class, kde_sampler)

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init =[{'amp': 25.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.04,
                  'e2': 0.1, 'R_sersic': 0.045, 'n_sersic': 3.0}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.040664784446933055,
                                   'e2': -0.14044048668704523, 'gamma': 1.9714547011154764, 'a4_a': 0.01754778225671725,
                                   'a3_a': -0.01978279163146989, 'delta_phi_m3': -0.5127349870534571,
                                   'delta_phi_m4': 0.0}, {'gamma1': -0.03, 'gamma2': 0.065}]
