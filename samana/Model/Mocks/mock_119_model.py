...
class _Mock119ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock119ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock119ModelEPLM3M4Shear(_Mock119ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock119ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.06148316858234294,
                              'e2': -0.0460796851575113, 'gamma': 1.9726659485144802,  'a3_a': 0.004036899835525279,
                              'a4_a': -0.02453703854165238,
                              'delta_phi_m3': -0.19870740155069727, 'delta_phi_m4': 0.0},
