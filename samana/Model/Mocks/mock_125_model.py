...
class _Mock125ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock125ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock125ModelEPLM3M4Shear(_Mock125ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock125ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.18682337946312777,
                              'e2': -0.0008764087741088152, 'gamma': 1.8253811747868558, 'a3_a': -8.267969247489506e-05,
                               'a4_a': -0.008771506277962443,
                              'delta_phi_m3': -0.07818104433618772, 'delta_phi_m4': 0.0},
                             {'gamma1': 0.0, 'gamma2': 0.06}]
