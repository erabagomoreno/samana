...
class _Mock122ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock122ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock122ModelEPLM3M4Shear(_Mock122ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock122ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': -0.021353936172163232,
                              'e2': -0.13645030019775242, 'gamma': 2.0096695516109544, 'a3_a': 0.0005886828994599322,
                              'a4_a': -0.012553351337511098,
                              'delta_phi_m3': -0.34245565667921585, 'delta_phi_m4': 0.0},
                             {'gamma1': 0.09, 'gamma2': 0.04}]
