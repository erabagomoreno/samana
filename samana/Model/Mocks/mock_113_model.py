...
class _Mock113ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock113ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock113ModelEPLM3M4Shear(_Mock113ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock113ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.03347086534135391,
                              'e2': 0.20630410020204393, 'gamma': 2.1341763232296397, 'a3_a': -0.0007761688004448916, 'a4_a': 0.010085653642025516,
                              'delta_phi_m3': -0.261393009963642, 'delta_phi_m4': 0.0},
