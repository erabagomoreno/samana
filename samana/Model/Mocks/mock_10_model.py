...
class Mock10Model(MockModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        self._shapelets_order = shapelets_order
        super(Mock10Model, self).__init__(data_class, kde_sampler)

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 19.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.07,
                  'e2': 0.04, 'R_sersic': 0.054, 'n_sersic': 4.0}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.0010025953139360796,
                              'e2': 0.16708081865317795, 'gamma': 1.933562029172763, 'a4_a': -0.001354484915560101,
                              'a3_a': 0.00018886307201135396, 'delta_phi_m3': 0.28412631321802206,
                              'delta_phi_m4': 0.0}, {'gamma1': 0.01, 'gamma2': -0.025}]
