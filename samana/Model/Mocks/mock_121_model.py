...
class _Mock121ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock121ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock121ModelEPLM3M4Shear(_Mock121ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock121ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro =  [{'theta_E': 1.0, 'center_x': 0.0,
                               'center_y': 0.0, 'e1': 0.06543629656710698,
                               'e2': 0.11995810265706584, 'gamma': 1.9372312230508113,  'a3_a': 0.0032173273413818267,
                               'a4_a': 0.00039337124061885004,
                               'delta_phi_m3': 0.10430438271694742, 'delta_phi_m4': 0.0},
                              {'gamma1': 0.06, 'gamma2': -0.07}]
