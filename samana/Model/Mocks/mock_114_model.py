...
class _Mock114ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock114ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock114ModelEPLM3M4Shear(_Mock114ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock114ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': -0.08136721331574763,
                              'e2': -0.19627680826375923, 'gamma': 2.0236546917909175, 'a3_a': 0.0044620723353153155, 'a4_a': 0.009055970669207337,
                              'delta_phi_m3': 0.06465535716019555, 'delta_phi_m4': 0.0},
                             {'gamma1': 0.09, 'gamma2': -0.02}]
