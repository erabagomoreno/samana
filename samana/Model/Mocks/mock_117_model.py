...
class _Mock117ModelBase(ModelBase):


    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock117ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock117ModelEPLM3M4Shear(_Mock117ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock117ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.21425737254355393,
                              'e2': 0.048182067028349866, 'gamma': 2.0139839677448608, 'a3_a': 0.000014004907047293757, 'a4_a': 0.010695619095991218,
                              'delta_phi_m3': 0.0452231728514213, 'delta_phi_m4': 0.0},
