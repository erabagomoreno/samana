...
class _Mock129ModelBase(ModelBase):

    def __init__(self, data_class, kde_sampler, shapelets_order):
        self._shapelets_order = shapelets_order
        super(_Mock129ModelBase, self).__init__(data_class, kde_sampler)
...
class Mock129ModelEPLM3M4Shear(_Mock129ModelBase):

    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(Mock129ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0,
                              'center_y': 0.0, 'e1': 0.08767123941484302,
                              'e2': -0.003702629972807537, 'gamma': 2.003893267325621, 'a3_a': 0.006997616725181699,
                              'a4_a': -0.005698022347617852,
                              'delta_phi_m3': 0.4829654511742806, 'delta_phi_m4': 0.0},
                             {'gamma1': -0.04, 'gamma2': 0.04}]
