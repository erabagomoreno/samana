...
class Mock20Model_dual(MockModelBase):
    ...
    def setup_source_light_model(self):
        ...
        kwargs_source_init = [{'amp': 15.0, 'center_x': 0.06, 'center_y': -0.1, 'e1': 0.2,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.2126010548992101,
                              'e2': 0.024915542983539554, 'gamma': 1.937935784265008,
                              'a4_a': 0.01502275707396579, 'a3_a': -0.004752215583806204,
                              'delta_phi_m3': 0.092290359073116, 'delta_phi_m4': 0.0},
