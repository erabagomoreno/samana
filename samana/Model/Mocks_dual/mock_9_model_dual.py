...
class Mock9Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init =[{'amp': 25.0, 'center_x': -0.04, 'center_y': 0.12, 'e1': 0.04,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.1754778225671725,
                                   'e2': -0.040664784446933055, 'gamma': 1.8595595133129548, 'a4_a': -0.039565583262939785,
                                   'a3_a': 0.005, 'delta_phi_m3': -0.5127349870534571,
