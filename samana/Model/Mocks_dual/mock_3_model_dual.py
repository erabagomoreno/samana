...
class Mock3Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 8.0, 'center_x': 0.02, 'center_y': 0.06, 'e1': 0.1,
                  'e2': -0.2, 'R_sersic': 0.067, 'n_sersic': 3.8}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.09805538702908832,
                              'e2': 0.002701904179452389, 'gamma': 1.9539957879337315,
                              'a4_a': 0.010248068016826362,
                              'a3_a': -0.005147357370025712, 'delta_phi_m3': 0.053195439182018855,
                              'delta_phi_m4': 0.0}, {'gamma1': -0.01, 'gamma2': 0.09}]
