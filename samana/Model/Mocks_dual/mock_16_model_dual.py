...
class Mock16Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': -0.075, 'center_y': 0.08, 'e1': 0.2,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.013202024617633541,
                              'e2': -0.04307405811914723, 'gamma': 2.0712479876972103, 'a4_a': 0.012309881482162046,
                              'a3_a': 0.013472342152438907, 'delta_phi_m3': -0.2897689043046673,
