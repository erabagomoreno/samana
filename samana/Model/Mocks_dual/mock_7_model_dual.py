...
class Mock7Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 35.0, 'center_x': 0.12, 'center_y': -0.1, 'e1': -0.2,
                  'e2': -0.1, 'R_sersic': 0.035, 'n_sersic': 4.5}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.009316606097975175,
                              'e2': 0.32009147091177126, 'gamma': 2.0, 'a4_a': 0.014570832287334776,
                              'a3_a': -0.0016030162747218797, 'delta_phi_m3': -0.4436889218298895,
