...
class Mock17Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': 0.2, 'center_y': 0.1, 'e1': 0.2,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.12363978905818813,
                              'e2': 0.14055350285790214, 'gamma': 1.9485064434364303, 'a4_a': 0.0013644422519358524,
                              'a3_a': -0.006880462863800891, 'delta_phi_m3': -0.21502630636101866, 'delta_phi_m4': 0.0},
                             {'gamma1': 0.0, 'gamma2': -0.04}]
