...
class Mock6Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 40.382, 'center_x': 0.09, 'center_y': -0.045, 'e1': 0.37,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.07603400411704919,
                              'e2': 0.24238190469213294, 'gamma': 2.0,
