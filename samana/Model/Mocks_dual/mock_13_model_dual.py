...
class Mock13Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 5.0, 'center_x': -0.02, 'center_y':  -0.14, 'e1': 0.05,
                  'e2': 0.1, 'R_sersic': 0.08, 'n_sersic': 4.0}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.22066354572659455,
                              'e2': -0.09420233055103952, 'gamma': 2.063256852303305, 'a4_a': -0.0053543373280677264,
                              'a3_a': 0.003307751130197963, 'delta_phi_m3': 0.29080928431429665,
                              'delta_phi_m4': 0.0}, {'gamma1': 0.01, 'gamma2': -0.02}]
