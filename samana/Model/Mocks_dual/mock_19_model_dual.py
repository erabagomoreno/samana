...
class Mock19Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': 0.1, 'center_y': -0.03, 'e1': 0.2,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.040069713588407205,
                              'e2': -0.0860258913785972, 'gamma': 2.024470140093218,
                              'a4_a': 0.00810376381521321, 'a3_a': -0.003924894009763735,
                              'delta_phi_m3': -0.4214618266868889, 'delta_phi_m4': 0.0},
