...
class Mock18Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 15.0, 'center_x': -0.015, 'center_y': 0.005, 'e1': 0.2,
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.033853490057942165,
                              'e2': -0.030578669991863445, 'gamma': 2.0790069719248727, 'a4_a': 0.00015188193653118965,
                              'a3_a': 0.00527221563870854, 'delta_phi_m3': 0.15747153771274558,
                              'delta_phi_m4': 0.0}, {'gamma1': 0.06, 'gamma2': -0.07}]
