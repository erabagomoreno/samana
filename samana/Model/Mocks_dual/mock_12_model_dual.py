...
class Mock12Model_dual(MockModelBase):

    def setup_source_light_model(self):
        source_model_list = ['SERSIC_ELLIPSE']
        kwargs_source_init = [{'amp': 50.0, 'center_x': 0.045, 'center_y': 0.07, 'e1': -0.25,
                  'e2': 0.04, 'R_sersic': 0.024, 'n_sersic': 3.0}]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None,
        ...
        kwargs_lens_macro = [{'theta_E': 1.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': -0.03288947350554445,
                              'e2': 0.0022859778522262854, 'gamma': 1.95793079624987, 'a4_a': 0.008941596482682836,
                              'a3_a': -0.004408132271037109, 'delta_phi_m3': -0.3621598245727988, 'delta_phi_m4': 0.0},
