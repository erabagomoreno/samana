...
class J0659ModelEPLM3M4Shear(_J0659ModelBase):
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [{'theta_E': 2.435980947148659, 'gamma': 1.89, 
                              'e1': -0.08214414792077979, 'e2': -0.0754564137396995, 
                              'center_x': 0.0018067467059059987, 'center_y': 0.0001992200379005686,
                              'a3_a': 0.0,
                              'delta_phi_m3': 0.0, 'a4_a': 0.0,
                              'delta_phi_m4': 0.0}, 
                              {'gamma1': 0.010304292416589459, 'gamma2': 0.026736939313574157, 'ra_0': 0, 'dec_0': 0},
                              {'theta_E': 0.046, 'center_x':-1.376806746705906, 'center_y':2.4418007799620995}]
        #[{'theta_E': 0.6946078865697751, 'gamma': 1.89, 
