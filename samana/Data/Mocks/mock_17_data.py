...
from samana.Data.ImageData.MockImageData.mock_17_cosmos import image_data as cosmos_image_data
from samana.Data.ImageData.MockImageData.mock_17_cosmos_wdm import image_data as cosmos_image_data_wdm
...
class Mock17DataWDM(MockBase):
    ...
    def __init__(self, super_sample_factor=1.0, cosmos_source=True):
        ...
        x_image = [1.10661, 0.3295, 0.81446, -0.59055]
        y_image = [-0.43864, 1.06805, 0.7433, -0.28066]
        magnifications_true = [4.82951, 8.83226, 10.10081, 1.19987]
        magnification_measurement_errors = 0.0
        magnifications = np.array(magnifications_true) + np.array(magnification_measurement_errors)
        astrometric_uncertainties = [0.003] * 4
        flux_ratio_uncertainties = None
        ...
        super(Mock17DataWDM, self).__init__(z_lens, z_source, x_image, y_image,
