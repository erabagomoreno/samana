...
from samana.Data.ImageData.MockImageData.mock_16_cosmos import image_data as cosmos_image_data
from samana.Data.ImageData.MockImageData.mock_16_cosmos_wdm import image_data as cosmos_image_data_wdm
...
class Mock16DataWDM(MockBase):
    ...
    def __init__(self, super_sample_factor=1.0, cosmos_source=True):
        ...
        x_image = [-1.13315, 0.56331, -0.2425, 0.44737]
        y_image = [-0.1549, 0.89565, 0.96044, -0.68218]
        magnifications_true = [4.25205, 8.75227, 7.93225, 2.04307]
        magnification_measurement_errors = 0.0
        magnifications = np.array(magnifications_true) + np.array(magnification_measurement_errors)
        astrometric_uncertainties = [0.003] * 4
        flux_ratio_uncertainties = None
        ...
        super(Mock16DataWDM, self).__init__(z_lens, z_source, x_image, y_image,
