...
from samana.Data.ImageData.mock_9_cosmos_replacement import image_data as cosmos_image_data


class Mock26Data(MockBase):
    ...
    def __init__(self, super_sample_factor=1.0, cosmos_source=False):
        ...
        super(Mock26Data, self).__init__(z_lens, z_source, x_image, y_image,
